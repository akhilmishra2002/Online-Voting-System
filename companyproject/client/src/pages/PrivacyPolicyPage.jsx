...
export default function PrivacyPolicyPage() {
  return (
    <div className="p-8 min-h-screen flex flex-col justify-center bg-gradient-to-r from-[rgb(0,198,255)] to-[rgb(0,114,255)] text-gray-900">
      <div
      ...
      >
        <h1 className="text-3xl font-bold mb-6 text-center uppercase text-[rgb(0,198,255)]">
          Privacy Policy
        </h1>

        <h2 className="text-2xl font-semibold mb-4 text-[rgb(0,114,255)]">Introduction</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[rgb(0,114,255)]">Information We Collect</h2>
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[rgb(0,114,255)]">How We Use Your Information</h2>
        <ul className="list-disc list-inside mb-4">
          <li>
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[rgb(0,114,255)]">How We Protect Your Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[rgb(0,114,255)]">Sharing Your Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[rgb(0,114,255)]">Your Rights</h2>
        <ul className="list-disc list-inside mb-4">
          <li>
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[rgb(0,114,255)]">Changes to This Policy</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[rgb(0,114,255)]">Contact Us</h2>
        <p>
